...
- `launch`, `activate`, `move`, `drag`, `click --foreground`: refused while the frontmost app
  is fullscreen unless `--confirm` — bringing another app forward (or taking the cursor over
  the game) switches Spaces and throws the human out of it.
